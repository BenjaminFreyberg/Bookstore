...
function init() {
    for (let i = 0; i < books.length; i++) {
        ...
        let commentsHTML = '';
        books[i].comments.forEach(function(comment) {
            commentsHTML += `
                <tr class="comment-container">
                    <td id="comment_name" class="td-streched">${comment.name}</td>
                    <td>:</td>
                    <td id="comment_text" >${comment.comment}</td>
                </tr>`;
        });
       
       

                document.getElementById('main-container').innerHTML += `<div class="center-card">
                  <div class="card" style="width: 22rem">
                    <div class="card-body">
                      <h5 class="card-title" id="BookName">${name}</h5>
                    </div>
                    <div class="divider"></div>
                    <div class="book-image">
                      <img src="./img/book_card.png" width="20%" />
                    </div>
                    <div class="divider"></div>
                    <div class="price-like-container">
                      ...
                      <div class="likes-image">
                        ...
                        <img src="./img/likebutton.png" class="like-button" />
                      </div>
                    </div>
                    <div>
                      <table>
                    ...
                    <tr class="comment-container">
                        <td id="comment_name"></td>
                        <td></td>
                        <td id="comment_text">${commentsHTML}</td>
                    </tr>
                </table>
                <div class="comment-area">
                <input class="form-control comment-design" type="text" placeholder="Schreibe deinen Kommentar hier!">
                <img class="sendit" src=./img/sendit.png type="submit">
                </div>
            </div>
